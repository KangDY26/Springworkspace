...
//		System.out.println("coffee3의 해쉬코드 값: " + coffee3.hashCode());
		...
		log.info("coffee1의 모든 값으 통해 도출해낸 해쉬코드 값: {}", coffee1.hashCode());
		log.info("coffee2의 해쉬코드 값: {}", coffee2.hashCode());
		log.info("coffee3의 해쉬코드 값: {}", coffee3.hashCode());
...
//				+ coffee2.equals(coffee3));
		...
		log.error("coffee1과 coffee2의 해쉬코드가 다르므로 다른 객체: {}",
				coffee1.equals(coffee2));
		log.error("coffee2과 coffee3의 해쉬코드가 같으므로 같은 객체: {}",
				coffee2.equals(coffee3));
